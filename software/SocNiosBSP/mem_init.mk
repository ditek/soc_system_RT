...
# Memory: cpu_memory
MEM_0 := soc_system_cpu_memory
$(MEM_0)_NAME := cpu_memory
...
$(MEM_0)_END := 0x00049fff
$(MEM_0)_SPAN := 0x0000a000
$(MEM_0)_HIERARCHICAL_PATH := cpu_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: cpu_memory
cpu_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: data_memory
MEM_1 := soc_system_data_memory
